...
import { Shield, Lock, CheckCircle2, ArrowRight, FileCheck, Search, Activity, Scale } from "lucide-react";
                ...
                <section className="pt-60 pb-32 px-8 border-b border-foreground/5">
                    <div className="max-w-7xl mx-auto">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-sans font-black text-primary uppercase tracking-[0.2em]">Continuous Improvement Role</span>
                        </motion.div>
                        ...
                        <p className="text-xl text-foreground/70 max-w-2xl font-sans leading-relaxed mb-12">
                            Persistent vigilance for your ISMS. Our outsourced internal auditors ensure that compliance is a daily operational reality, not a once-a-year event.
                        </p>
                    </div>
                </section>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
                            <div>
                                ...
                                <p className="text-lg text-foreground/50 font-sans mb-12 max-w-lg leading-relaxed">
                                    The internal auditor acts as a neutral "Quality Gate," verifying that your security controls are functioning as intended between formal certification cycles.
                                </p>
                                <div className="space-y-6">
                                    {[
                                        { title: "Continuous Monitoring", desc: "Rolling audit programs that cover every ISO/TISAX chapter over the course of the fiscal year." },
                                        { title: "Control Verification", desc: "Empirical testing of logical and physical safeguards to ensure they haven't drifted from baseline." },
                                        { title: "Remediation Support", desc: "Collaborating with IT teams to close non-conformities identified during internal inspections." }
                                    ].map((pillar, i) => (
                            ...
                            <div className="space-y-8">
                                <div className="p-12 border border-foreground/10 rounded-[2.5rem] bg-surface">
                                    <FileCheck className="w-12 h-12 text-primary mb-8" />
                                    <h4 className="text-2xl font-display font-black mb-4 tracking-tight">Audit Health Score</h4>
                                    <p className="text-sm text-foreground/50 leading-relaxed mb-8">
                                        Don't let your compliance posture decay. Our internal auditors maintain a live "audit readiness" dashboard.
                                    </p>
                                    <Link href="/about" className="text-xs font-black text-primary flex items-center gap-2 hover:gap-3 transition-all uppercase tracking-widest">
                                        ISMS Health Check <ArrowRight className="w-4 h-4" />
                                    </Link>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {[
                                        { title: "Control Testing", icon: Shield },
                                        { title: "Evidence Map", icon: Search },
                                        { title: "Policy Review", icon: Scale },
                                        { title: "Process Audit", icon: Activity }
                                    ].map((item, i) => (
